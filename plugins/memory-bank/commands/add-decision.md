---
description: Add a technical decision (ADR-style) to a feature's DECISIONS.md in the Memory Bank.
---
...
Read `references/templates.md` from the Memory Bank skill directory — specifically the DECISIONS.md template for the ADR format.

## Action

Run **Workflow 4: Manual Decision** from SKILL.md.
